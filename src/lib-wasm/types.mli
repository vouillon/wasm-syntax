...
(** Add a recursive type definition to the context. Returns the index of the first type defined.
    Assumes normalized types (use negative numbers for recursive references). *)
