...
and instruction ch =
  ...
  let desc =
    ...
    | 0xFD -> (
        ...
        | 94 -> VecUnOp (VecDemote (`F64, F32x4))
        | 83 -> VecTest (AnyTrue I8x16) (* v128.any_true *)
        | 96 -> VecUnOp (VecAbs I8x16)
        | 97 -> VecUnOp (VecNeg I8x16)
        | 98 -> VecUnOp (VecPopcnt I8x16)
        ...
        | 124 -> VecUnOp (VecExtAddPairwise (Signed, I16x8))
        | 125 -> VecUnOp (VecExtAddPairwise (Unsigned, I16x8))
        | 126 -> VecUnOp (VecExtAddPairwise (Signed, I32x4))
        | 127 -> VecUnOp (VecExtAddPairwise (Unsigned, I32x4))
        ...
        | 188 -> VecBinOp (VecExtMulLow (Signed, I32x4))
        | 189 -> VecBinOp (VecExtMulHigh (Signed, I32x4))
        | 190 -> VecBinOp (VecExtMulLow (Unsigned, I32x4))
        | 191 -> VecBinOp (VecExtMulHigh (Unsigned, I32x4))
        ...
        | 220 -> VecBinOp (VecExtMulLow (Signed, I64x2))
        | 221 -> VecBinOp (VecExtMulHigh (Signed, I64x2))
        | 222 -> VecBinOp (VecExtMulLow (Unsigned, I64x2))
        | 223 -> VecBinOp (VecExtMulHigh (Unsigned, I64x2))
