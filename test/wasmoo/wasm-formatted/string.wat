...
(func $string_compare (param $p1 (ref eq)) (param $p2 (ref eq)) (result i32)
  (local $s1 (ref $string)) (local $s2 (ref $string)) (local $l1 i32)
  (local $l2 i32) (local $len i32) (local $i i32) (local $c1 i32)
  (local $c2 i32)
  (if (ref.eq (local.get $p1) (local.get $p2)) (then (return (i32.const 0))))
  (local.set $s1 (ref.cast (ref $string) (local.get $p1)))
  (local.set $s2 (ref.cast (ref $string) (local.get $p2)))
...
(func $caml_string_lessequal (export "caml_string_lessequal")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (i32.le_s (call $string_compare (local.get 0) (local.get 1))
      (i32.const 0)))
)
...
(func $caml_string_lessthan (export "caml_string_lessthan")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (i32.lt_s (call $string_compare (local.get 0) (local.get 1))
      (i32.const 0)))
)
...
(func $caml_string_greaterequal (export "caml_string_greaterequal")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (i32.ge_s (call $string_compare (local.get 0) (local.get 1))
      (i32.const 0)))
)
...
(func $caml_string_greaterthan (export "caml_string_greaterthan")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (i32.gt_s (call $string_compare (local.get 0) (local.get 1))
      (i32.const 0)))
)
...
(func (export "caml_create_bytes") (param $len (ref eq)) (result (ref eq))
  (local $l i32)
...
(func $caml_bytes_get64 (export "caml_bytes_get64")
  ...
  (i64.or
    (i64.or
      (i64.or
        (i64.extend_i32_u (array.get_u $string (local.get $s) (local.get $p)))
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $string (local.get $s)
              (i32.add (local.get $p) (i32.const 1))))
...
(func (export "caml_string_concat")
  ...
  (array.copy $string $string (local.get $s) (local.get $l1) (local.get $s2)
    (i32.const 0) (local.get $l2))
  (local.get $s)
)
