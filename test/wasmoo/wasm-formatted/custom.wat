(module
        ...
        (struct.get $custom_operations $dup
          (struct.get $custom 0
            (block $custom (result (ref $custom))
              (drop
                (br_on_cast $custom (ref eq) (ref $custom) (local.get $v)))
              (unreachable))))))
  )
  (func (export "custom_compare_id")
    (param (ref eq) (ref eq) i32) (result i32)
    ...
    (block $not_found
      ...
      (loop $loop
        (if
          ...
          (then
            (return (struct.get $custom_operations_list $ops (local.get $l)))))
        (local.set $l
  ...
  (func (export "caml_custom_identifier")
