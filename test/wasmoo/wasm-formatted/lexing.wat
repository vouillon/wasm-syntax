...
(func (export "caml_lex_engine")
  ...
  (local $backtrk i32) (local $lex_base (ref $string))
  (local $lex_backtrk (ref $string)) (local $lex_check (ref $string))
  (local $lex_check_code (ref $string)) (local $lex_trans (ref $string))
...
(func (export "caml_new_lex_engine")
  ...
  (local $base_code i32) (local $lex_code (ref $string))
  (local $lex_base (ref $string)) (local $lex_base_code (ref $string))
  (local $lex_backtrk (ref $string)) (local $lex_backtrk_code (ref $string))
  (local $lex_check (ref $string)) (local $lex_check_code (ref $string))
  (local $lex_trans (ref $string)) (local $lex_trans_code (ref $string))
  (local $lex_default (ref $string)) (local $lex_default_code (ref $string))
  (local.set $tbl (ref.cast (ref $block) (local.get $vtbl)))
  (local.set $lexbuf (ref.cast (ref $block) (local.get $vlexbuf)))
  (local.set $state (i31.get_s (ref.cast (ref i31) (local.get $start_state))))
  (local.set $buffer
      ...
      (if (result i32)
        ...
        (then
          (call $get (local.get $lex_trans_code)
            (i32.add (local.get $base_code) (local.get $c))))
        (else (call $get (local.get $lex_default_code) (local.get $pstate)))))
