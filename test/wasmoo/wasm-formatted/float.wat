(module
  ...
  (func (export "caml_modf_float") (param (ref eq)) (result (ref eq))
    ...
    (if (f64.ge (local.get $a) (f64.const 0))
      ...
      (else (local.set $i (local.get $x)) (local.set $f (local.get $x))))
  ...
  (func (export "caml_fma_float")
    ...
    (result (ref eq))
    (local $x f64) (local $y f64) (local $z f64) (local $3 i64)
    (local $4 i64) (local $5 i64) (local $6 i64) (local $7 i64)
    (local $8 i64) (local $9 i32) (local $10 i32) (local $11 f64)
    (local $12 f64) (local $13 f64) (local $14 f64) (local $15 f64)
    (local.set $x
