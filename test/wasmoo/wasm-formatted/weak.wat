...
(func (export "caml_ephe_unset_data") (param $vx (ref eq)) (result (ref eq))
  (local $x (ref $block))
  (local.set $x (ref.cast (ref $block) (local.get $vx)))
  (array.set $block (local.get $x) (global.get $caml_ephe_data_offset)
    (global.get $caml_ephe_none))
...
(func (export "caml_ephe_check_data") (param $x (ref eq)) (result (ref eq))
  (ref.i31
    (i32.eqz
...
(func $caml_ephe_set_data_opt (param $x (ref eq)) (param $opt_data (ref eq))
  (drop
    (block $no_data (result (ref eq))
...
(func $caml_ephe_check_key (export "caml_ephe_check_key")
  ...
  (block $value
    (block $no_value
      ...
      (br_if $value
        (i32.eqz
          (ref.is_null (call $weak_deref (call $unwrap (local.get $v))))))
      (array.set $block (local.get $x) (local.get $i)
        (global.get $caml_ephe_none))
      (array.set $block (local.get $x) (global.get $caml_ephe_data_offset)
        (global.get $caml_ephe_none)))
...
(func $caml_ephe_set_key (export "caml_ephe_set_key")
  ...
  (if (ref.test (ref i31) (local.get $v))
    (then
      (if
        (ref.test (ref $js) (array.get $block (local.get $x) (local.get $i)))
        (then (local.set $d (call $caml_ephe_get_data (local.get $vx)))))
...
(func $caml_ephe_blit_key (export "caml_ephe_blit_key")
  ...
  (array.copy $block $block (ref.cast (ref $block) (local.get $y))
...
(func (export "caml_weak_set")
  ...
  (result (ref eq))
  (drop
    (block $unset (result (ref eq))
      (return_call $caml_ephe_set_key (local.get $x) (local.get $i)
        (array.get $block
