...
(func (export "caml_sys_executable_name") (param (ref eq)) (result (ref eq))
  (array.get $block
...
(func (export "caml_sys_random_seed") (param (ref eq)) (result (ref eq))
...
(func (export "caml_sys_const_bigendian") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)

(func (export "caml_sys_const_word_size") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 32))
)

(func (export "caml_sys_const_int_size") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 31))
)

(func (export "caml_sys_const_max_wosize") (param (ref eq)) (result (ref eq))
...
(func (export "caml_sys_isatty") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)
