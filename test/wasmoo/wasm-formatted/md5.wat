...
(func $MD5Update
      ...
      (if (i32.lt_u (local.get $input_len) (local.get $missing))
        (then
          (array.copy $string $string
            (struct.get $context 3 (local.get $ctx)) (local.get $missing)
            (local.get $input) (local.get $input_pos) (local.get $input_len))
          (return)))
      (array.copy $string $string (struct.get $context 3 (local.get $ctx))
  ...
  (loop $loop
    (if (i32.ge_u (local.get $input_len) (i32.const 64))
      (then
        (call $MD5Transform (struct.get $context 0 (local.get $ctx))
          (struct.get $context 2 (local.get $ctx)) (local.get $input)
          (local.get $input_pos))
      ...
      (loop $loop
        (if (i32.lt_u (local.get $i) (i32.const 64))
          (then
            ...
            (br $loop))))
      (call $MD5Transform (struct.get $context 0 (local.get $ctx))
        (struct.get $context 2 (local.get $ctx)) (local.get $buffer)
        (i32.const 0))
