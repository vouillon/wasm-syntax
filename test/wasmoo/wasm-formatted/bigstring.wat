(module
  ...
  (import "bigarray" "caml_ba_sub"
    (func $caml_ba_sub (param (ref eq) (ref eq) (ref eq)) (result (ref eq)))
  )
  (import "bigarray" "caml_ba_fill"
    (func $caml_ba_fill (param (ref eq) (ref eq)) (result (ref eq)))
  )
  ...
  (func (export "caml_bigstring_memcmp")
    ...
    (local $c1 i32) (local $c2 i32) (local $d1 (ref extern))
    (local $d2 (ref extern))
    ...
    (loop $loop
      (if (i32.lt_u (local.get $i) (local.get $len))
        (then
          ...
          (return
            (select (result (ref eq)) (ref.i31 (i32.const -1))
              (ref.i31 (i32.const 1))
  ...
  (func $caml_bigstring_blit_bytes_to_ba
    ...
    (local $s1 (ref $string)) (local $d2 (ref extern))
  ...
  (func (export "caml_bigstring_blit_ba_to_bytes")
    ...
    (param $vpos2 (ref eq)) (param $vlen (ref eq)) (result (ref eq))
    (local $pos1 i32) (local $pos2 i32) (local $len i32)
    (local $d1 (ref extern)) (local $s2 (ref $string))
    (local.set $d1 (call $caml_ba_get_data (local.get $ba1)))
    (local.set $pos1 (i31.get_s (ref.cast (ref i31) (local.get $vpos1))))
    (local.set $s2 (ref.cast (ref $string) (local.get $str2)))
    (local.set $pos2 (i31.get_s (ref.cast (ref i31) (local.get $vpos2))))
    (local.set $len (i31.get_s (ref.cast (ref i31) (local.get $vlen))))
    (call $ta_blit_to_string (local.get $d1) (local.get $pos1)
      (local.get $s2) (local.get $pos2) (local.get $len))
    (ref.i31 (i32.const 0))
  )
