(module
  ...
  (func (export "caml_sys_getcwd") (param (ref eq)) (result (ref eq))
    (return_call $caml_string_of_jsstring (call $wrap (call $getcwd)))
  )
  (func (export "caml_sys_chdir") (param $name (ref eq)) (result (ref eq))
    (try
      (do
        (call $chdir
  ...
  (func (export "caml_sys_remove") (param $name (ref eq)) (result (ref eq))
    (try
      (do
        (call $unlink
          (call $unwrap (call $caml_jsstring_of_string (local.get $name)))))
  ...
  (func (export "caml_read_file_content") (param (ref eq)) (result (ref eq))
    (call $caml_raise_no_such_file (local.get 0))
    (ref.i31 (i32.const 0))
  )
  (func (export "caml_fs_init") (result (ref eq)) (ref.i31 (i32.const 0)))
