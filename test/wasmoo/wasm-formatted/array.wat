...
(func (export "caml_floatarray_sub")
  (param $a (ref eq)) (param $i (ref eq)) (param $vlen (ref eq))
  (result (ref eq))
  (local $len i32) (local $fa1 (ref $float_array))
  (local $fa2 (ref $float_array))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
  (if (i32.eqz (local.get $len)) (then (return (global.get $empty_array))))
  (local.set $fa1 (ref.cast (ref $float_array) (local.get $a)))
  (local.set $fa2 (array.new $float_array (f64.const 0) (local.get $len)))
          ...
          (local.set $a
            (array.new $block (ref.i31 (i32.const 0))
              (i32.sub (i32.add (local.get $l1) (local.get $l2))
                (i32.const 1))))
          (array.copy $block $block (local.get $a) (i32.const 1)
            (local.get $a1) (i32.const 1)
...
(func (export "caml_array_concat") (param (ref eq)) (result (ref eq))
  (local $i i32) (local $len i32) (local $l (ref eq)) (local $v (ref eq))
  (local $isfloat i32) (local $b (ref $block)) (local $a (ref $block))
          ...
          (block $exit (result (ref eq))
            ...
            (drop
              (block $not_float (result (ref eq))
                ...
                (array.copy $float_array $float_array (local.get $fa)
...
(func $caml_floatarray_blit (export "caml_floatarray_blit")
  (param $a1 (ref eq)) (param $i1 (ref eq)) (param $a2 (ref eq))
  (param $i2 (ref eq)) (param $vlen (ref eq)) (result (ref eq))
  (local $len i32)
  ...
  (if (local.get $len)
    (then
      (array.copy $float_array $float_array
        ...
        (i31.get_s (ref.cast (ref i31) (local.get $i1))) (local.get $len))))
  (ref.i31 (i32.const 0))
)
  ...
  (if (local.get $len)
    (then
      (if (ref.test (ref $float_array) (local.get $a1))
        (then
          (return_call $caml_floatarray_blit (local.get $a1) (local.get $i1)
