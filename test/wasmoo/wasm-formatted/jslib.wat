...
(type $block (array (mut (ref eq)))) (type $float (struct (field f64)))
...
(func (export "caml_js_equals") (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (call $equals (call $unwrap (local.get 0)) (call $unwrap (local.get 1))))
)

(func (export "caml_js_strict_equals")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (call $strict_equals (call $unwrap (local.get 0))
...
(func (export "caml_js_to_bool") (param (ref eq)) (result (ref eq))
  (ref.i31 (call $to_bool (call $unwrap (local.get 0))))
)
...
(func (export "caml_js_to_int32") (param (ref eq)) (result (ref eq))
  (return_call $caml_copy_int32 (call $to_int32 (call $unwrap (local.get 0))))
)
...
(func (export "caml_js_pure_expr") (param $f (ref eq)) (result (ref eq))
...
(func (export "caml_js_get") (param (ref eq) (ref eq)) (result (ref eq))
  (if (ref.test (ref $string) (local.get 1))
    (then (local.set 1 (call $caml_jsbytes_of_string (local.get 1)))))
  (return_call $wrap
    (call $get
...
(func (export "caml_js_delete") (param (ref eq) (ref eq)) (result (ref eq))
  (if (ref.test (ref $string) (local.get 1))
    (then (local.set 1 (call $caml_jsbytes_of_string (local.get 1)))))
...
(func (export "caml_js_instanceof")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31
    (call $instanceof (call $unwrap (local.get 0))
      (call $unwrap (local.get 1))))
)

(func (export "caml_js_typeof") (param (ref eq)) (result (ref eq))
...
(func (export "caml_js_object") (param (ref eq)) (result (ref eq))
...
(func (export "caml_js_to_array") (param (ref eq)) (result (ref eq))
  ...
  (if (local.get $l)
    (then
      (if
        (ref.test (ref $float) (call $array_get (local.get $a) (i32.const 0)))
        (then
          (local.set $fa
      ...
      (block $done
        (loop $loop
          (if (i32.lt_u (local.get $i) (local.get $count))
            (then
              (br_if $done (i32.eqz (call $caml_is_closure (local.get $acc))))
              (local.set $acc
                (call $caml_callback_1 (local.get $acc)
                  (call $wrap
                    (call $get (local.get $args) (ref.i31 (local.get $i))))))
...
(func (export "caml_list_to_js_array") (param (ref eq)) (result (ref eq))
...
(func (export "caml_list_of_js_array") (param (ref eq)) (result (ref eq))
