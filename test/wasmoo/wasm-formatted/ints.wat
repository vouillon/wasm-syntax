(module
      ...
      (then
        (if
          ...
          (then
            ...
            (if
              (i32.or (i32.eq (local.get $c) (i32.const 88))
              ...
              (else
                (if
                  (i32.or (i32.eq (local.get $c) (i32.const 79))
                  ...
                  (else
                    (if
                      (i32.or (i32.eq (local.get $c) (i32.const 66))
                      ...
                      (else
                        (if
                          (i32.or (i32.eq (local.get $c) (i32.const 85))
                            (i32.eq (local.get $c) (i32.const 117)))
                          (then
                            (local.set $signedness (i32.const 0))
                            (local.set $i
                              (i32.add (local.get $i) (i32.const 2)))))))))))))))
    (tuple.make 4 (local.get $i) (local.get $signedness) (local.get $sign)
      (local.get $base))
  )
  ...
  (func $parse_int (export "parse_int")
    ...
    (local $c i32) (local $signedness i32) (local $sign i32)
    (local $base i32) (local $res i32) (local $threshold i32)
    ...
    (if (local.get $signedness)
      (then
        (local.set $threshold
          (i32.shl (i32.const 1) (i32.sub (local.get $nbits) (i32.const 1))))
      ...
      (else
        (if
          (i32.and (i32.lt_u (local.get $nbits) (i32.const 32))
  ...
  (global $INT_ERRMSG (ref $string)
    (array.new_fixed $string 13 (i32.const 105) (i32.const 110)
      (i32.const 116) (i32.const 95) (i32.const 111) (i32.const 102)
      (i32.const 95) (i32.const 115) (i32.const 116) (i32.const 114)
      (i32.const 105) (i32.const 110) (i32.const 103))
  )
  (func (export "caml_int_of_string") (param $v (ref eq)) (result (ref eq))
    (ref.i31
  ...
  (global $lowercase_hex_table (export "lowercase_hex_table") (ref $chars)
    (array.new_fixed $chars 16 (i32.const 48) (i32.const 49) (i32.const 50)
      (i32.const 51) (i32.const 52) (i32.const 53) (i32.const 54)
      (i32.const 55) (i32.const 56) (i32.const 57) (i32.const 97)
      (i32.const 98) (i32.const 99) (i32.const 100) (i32.const 101)
      (i32.const 102))
  )
  (global $uppercase_hex_table (export "uppercase_hex_table") (ref $chars)
    (array.new_fixed $chars 16 (i32.const 48) (i32.const 49) (i32.const 50)
      (i32.const 51) (i32.const 52) (i32.const 53) (i32.const 54)
      (i32.const 55) (i32.const 56) (i32.const 57) (i32.const 65)
      (i32.const 66) (i32.const 67) (i32.const 68) (i32.const 69)
      (i32.const 70))
  )
  ...
  (func $parse_int_format (export "parse_int_format")
    ...
    (block $return
      (block $bad_format
        ...
        (if
          (i32.or
            (i32.or (i32.eq (local.get $c) (i32.const 76))
                ...
                (if (i32.eq (local.get $c) (i32.const 120))
                  ...
                  (else
                    (if (i32.eq (local.get $c) (i32.const 88))
                      ...
                      (else
                        (if (i32.eq (local.get $c) (i32.const 111))
                          (then (local.set $base (i32.const 8)))
                          (else (br $bad_format)))))))))))
        (br $return))
      (call $caml_invalid_argument
        (array.new_data $string $format_error (i32.const 0) (i32.const 22))))
    (tuple.make 5 (local.get $sign_style) (local.get $alternate)
      (local.get $signed) (local.get $base) (local.get $uppercase))
  )
