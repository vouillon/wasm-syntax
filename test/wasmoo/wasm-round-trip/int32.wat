(module
  ...
  (global $int32_ops (export "int32_ops") (ref $custom_operations)
    (struct.new $custom_operations
      (array.new_fixed $string 2 (i32.const 95) (i32.const 105))
  ...
  (global $INT32_ERRMSG (ref $string)
    (array.new_fixed $string 15 (i32.const 73) (i32.const 110)
      (i32.const 116) (i32.const 51) (i32.const 50) (i32.const 46)
  ...
  (global $nativeint_ops (export "nativeint_ops") (ref $custom_operations)
    (struct.new $custom_operations
      (array.new_fixed $string 2 (i32.const 95) (i32.const 110))
      (ref.func $int32_cmp) (ref.null $compare) (ref.func $int32_hash)
  ...
  (global $NATIVEINT_ERRMSG (ref $string)
    (array.new_fixed $string 16 (i32.const 78) (i32.const 97) (i32.const 116)
      (i32.const 105) (i32.const 118) (i32.const 101) (i32.const 46)
      (i32.const 111) (i32.const 102) (i32.const 95) (i32.const 115)
      (i32.const 116) (i32.const 114) (i32.const 105) (i32.const 110)
      (i32.const 103))
  )
