(module
  ...
  (func $Int32_val (export "Int32_val") (param $x (ref eq)) (result i32)
  ...
  (global $INT32_ERRMSG (ref $string) (array.new_fixed $string 0))
  ...
  (global $NATIVEINT_ERRMSG (ref $string) (array.new_fixed $string 0))
