(module
  ...
  (func $caml_lex_engine (export "caml_lex_engine")
    ...
    (local $lex_check_code_2 (ref $string))
    (local $lex_trans_2 (ref $string)) (local $lex_default_2 (ref $string))
  ...
  (func $caml_new_lex_engine (export "caml_new_lex_engine")
    ...
    (local $lex_check_2 (ref $string))
    (local $lex_check_code_2 (ref $string))
    (local $lex_trans_2 (ref $string))
    (local $lex_trans_code_2 (ref $string))
        ...
        (if (result i32)
          ...
          (then
            (call $get (local.get $lex_trans_code_2)
              (i32.add (local.get $base_code) (local.get $c))))
          (else
            (call $get (local.get $lex_default_code_2) (local.get $pstate)))))
