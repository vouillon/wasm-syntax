...
(func $caml_lxm_next (export "caml_lxm_next")
  ...
  (local.set $a
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 0)))
      (i64.shl
        (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 1)))
        (i64.const 32))))
  (local.set $s
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 2)))
      (i64.shl
        (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 3)))
        (i64.const 32))))
  (local.set $q0
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 4)))
      (i64.shl
        (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 5)))
        (i64.const 32))))
  (local.set $q1
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 6)))
      (i64.shl
        (i64.extend_i32_u (call $ta_get_i32 (local.get $data) (i32.const 7)))
        (i64.const 32))))
