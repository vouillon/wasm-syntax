...
(type $char_table (array i8)) (type $int_array (array (mut i32)))
...
(func $re_match
  ...
  (local.set $prog
    (ref.cast (ref $block) (array.get $block (local.get $re) (i32.const 1))))
  (local.set $cpool
    (ref.cast (ref $block) (array.get $block (local.get $re) (i32.const 2))))
  (local.set $normtable
    (ref.cast (ref $string) (array.get $block (local.get $re) (i32.const 3))))
  (local.set $numgroups
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $re) (i32.const 4)))))
                                            ...
                                            (block $CHARNORM
                                              (block $CHAR
                                                ...
                                                (br_table $CHAR $CHARNORM
                                                  $STRING $STRINGNORM
                                                  $CHARCLASS $BOL $EOL
                                                  $WORDBOUNDARY $BEGGROUP
                                                  $ENDGROUP $REFGROUP $ACCEPT
                                                  $SIMPLEOPT $SIMPLESTAR
                                                  $SIMPLEPLUS $GOTO $PUSHBACK
      ...
      (if (i32.lt_u (local.get $i) (local.get $numgroups))
        (then
          ...
          (if
            (i32.or
              (i32.lt_s
                (array.get $int_array (local.get $group_start) (local.get $i))
                (i32.const 0))
              (i32.lt_s
...
(func $re_replacement_text (export "re_replacement_text")
  ...
  (local.set $orig (ref.cast (ref $string) (local.get $vorig)))
  (loop $loop
  ...
  (loop $loop
    (if (i32.lt_u (local.get $i) (local.get $l))
      (then
        ...
        (array.copy $string $string (local.get $res) (local.get $j)
          (local.get $orig) (local.get $start) (local.get $len))
