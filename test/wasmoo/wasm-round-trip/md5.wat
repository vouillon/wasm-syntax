...
(func $caml_md5_string (export "caml_md5_string") (export "caml_md5_bytes")
  ...
  (call $MD5Update (local.get $ctx) (ref.cast (ref $string) (local.get $x))
    (i31.get_u (ref.cast (ref i31) (local.get $x_2)))
...
(func $caml_md5_chan (export "caml_md5_chan")
  ...
  (if (i32.lt_s (local.get $len) (i32.const 0))
    (then
      (loop $loop
        (local.set $read
          (call $caml_getblock (local.get $ch) (local.get $buf) (i32.const 0)
            (i32.const 4096)))
        (if (local.get $read)
          (then
...
(func $hh
  (param $a i32) (param $b i32) (param $c i32) (param $d i32) (param $x i32)
  (param $s i32) (param $t i32) (result i32)
  (call $xx (i32.xor (local.get $b) (i32.xor (local.get $c) (local.get $d)))
    (local.get $a) (local.get $b) (local.get $x) (local.get $s)
    (local.get $t))
)
(func $ii
...
(func $MD5Transform
  ...
  (local.set $a
    (call $ff (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 0)) (i32.const 7)
      (i32.const 0xD76AA478)))
  (local.set $d
    (call $ff (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 1)) (i32.const 12)
      (i32.const 0xE8C7B756)))
  (local.set $c
    (call $ff (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      (array.get $int_array (local.get $buffer) (i32.const 2)) (i32.const 17)
      (i32.const 0x242070DB)))
  (local.set $b
    (call $ff (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      (array.get $int_array (local.get $buffer) (i32.const 3)) (i32.const 22)
      (i32.const 0xC1BDCEEE)))
  (local.set $a
    (call $ff (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 4)) (i32.const 7)
      (i32.const 0xF57C0FAF)))
  (local.set $d
    (call $ff (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 5)) (i32.const 12)
      (i32.const 0x4787C62A)))
  (local.set $c
    (call $ff (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      (array.get $int_array (local.get $buffer) (i32.const 6)) (i32.const 17)
      (i32.const 0xA8304613)))
  (local.set $b
    (call $ff (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      (array.get $int_array (local.get $buffer) (i32.const 7)) (i32.const 22)
      (i32.const 0xFD469501)))
  (local.set $a
    (call $ff (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 8)) (i32.const 7)
      (i32.const 0x698098D8)))
  (local.set $d
    (call $ff (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 9)) (i32.const 12)
  ...
  (local.set $a
    (call $gg (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      ...
      (i32.const 0xF61E2562)))
  (local.set $d
    (call $gg (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 6)) (i32.const 9)
  ...
  (local.set $b
    (call $gg (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      ...
      (i32.const 0xE9B6C7AA)))
  (local.set $a
    (call $gg (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 5)) (i32.const 5)
      (i32.const 0xD62F105D)))
  (local.set $d
    (call $gg (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 10)) (i32.const 9)
  ...
  (local.set $b
    (call $gg (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      ...
      (i32.const 0xE7D3FBC8)))
  (local.set $a
    (call $gg (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 9)) (i32.const 5)
      (i32.const 0x21E1CDE6)))
  (local.set $d
    (call $gg (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 14)) (i32.const 9)
      (i32.const 0xC33707D6)))
  (local.set $c
    (call $gg (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      (array.get $int_array (local.get $buffer) (i32.const 3)) (i32.const 14)
      (i32.const 0xF4D50D87)))
  (local.set $b
    (call $gg (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      (array.get $int_array (local.get $buffer) (i32.const 8)) (i32.const 20)
      (i32.const 0x455A14ED)))
  (local.set $a
    (call $gg (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 13)) (i32.const 5)
      (i32.const 0xA9E3E905)))
  (local.set $d
    (call $gg (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 2)) (i32.const 9)
      (i32.const 0xFCEFA3F8)))
  (local.set $c
    (call $gg (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      (array.get $int_array (local.get $buffer) (i32.const 7)) (i32.const 14)
  ...
  (local.set $a
    (call $hh (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      ...
      (i32.const 0xFFFA3942)))
  (local.set $d
    (call $hh (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 8)) (i32.const 11)
  ...
  (local.set $a
    (call $hh (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      ...
      (i32.const 0xA4BEEA44)))
  (local.set $d
    (call $hh (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 4)) (i32.const 11)
      (i32.const 0x4BDECFA9)))
  (local.set $c
    (call $hh (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      (array.get $int_array (local.get $buffer) (i32.const 7)) (i32.const 16)
  ...
  (local.set $a
    (call $hh (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      ...
      (i32.const 0x289B7EC6)))
  (local.set $d
    (call $hh (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 0)) (i32.const 11)
      (i32.const 0xEAA127FA)))
  (local.set $c
    (call $hh (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      (array.get $int_array (local.get $buffer) (i32.const 3)) (i32.const 16)
      (i32.const 0xD4EF3085)))
  (local.set $b
    (call $hh (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      (array.get $int_array (local.get $buffer) (i32.const 6)) (i32.const 23)
      (i32.const 0x04881D05)))
  (local.set $a
    (call $hh (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 9)) (i32.const 4)
  ...
  (local.set $b
    (call $hh (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      ...
      (i32.const 0xC4AC5665)))
  (local.set $a
    (call $ii (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 0)) (i32.const 6)
      (i32.const 0xF4292244)))
  (local.set $d
    (call $ii (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 7)) (i32.const 10)
  ...
  (local.set $b
    (call $ii (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      ...
      (i32.const 0xFC93A039)))
  (local.set $a
    (call $ii (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 12)) (i32.const 6)
      (i32.const 0x655B59C3)))
  (local.set $d
    (call $ii (local.get $d) (local.get $a) (local.get $b) (local.get $c)
      (array.get $int_array (local.get $buffer) (i32.const 3)) (i32.const 10)
  ...
  (local.set $b
    (call $ii (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      ...
      (i32.const 0x85845DD1)))
  (local.set $a
    (call $ii (local.get $a) (local.get $b) (local.get $c) (local.get $d)
      (array.get $int_array (local.get $buffer) (i32.const 8)) (i32.const 6)
  ...
  (local.set $c
    (call $ii (local.get $c) (local.get $d) (local.get $a) (local.get $b)
      ...
      (i32.const 0x2AD7D2BB)))
  (local.set $b
    (call $ii (local.get $b) (local.get $c) (local.get $d) (local.get $a)
      (array.get $int_array (local.get $buffer) (i32.const 9)) (i32.const 21)
      (i32.const 0xEB86D391)))
...
(func $MD5Init (result (ref $context))
  (struct.new $context
    (array.new_fixed $int_array 4 (i32.const 0x67452301)
      (i32.const 0xEFCDAB89) (i32.const 0x98BADCFE) (i32.const 0x10325476))
    (i64.const 0) (array.new $int_array (i32.const 0) (i32.const 16))
...
(func $MD5Update
  ...
  (struct.set $context $f_2 (local.get $ctx)
      ...
      (if (i32.lt_u (local.get $input_len) (local.get $missing))
        (then
          (array.copy $string $string
            (struct.get $context $f_4 (local.get $ctx)) (local.get $missing)
            (local.get $input) (local.get $input_pos) (local.get $input_len))
          (return)))
      (array.copy $string $string (struct.get $context $f_4 (local.get $ctx))
        (local.get $missing) (local.get $input) (local.get $input_pos)
        (local.get $missing))
      (call $MD5Transform (struct.get $context $f (local.get $ctx))
        (struct.get $context $f_3 (local.get $ctx))
        (struct.get $context $f_4 (local.get $ctx)) (i32.const 0))
      (local.set $input_pos
  ...
  (loop $loop
    (if (i32.ge_u (local.get $input_len) (i32.const 64))
      (then
        (call $MD5Transform (struct.get $context $f (local.get $ctx))
          (struct.get $context $f_3 (local.get $ctx)) (local.get $input)
          (local.get $input_pos))
  ...
  (if (local.get $input_len)
    (then
      (array.copy $string $string (struct.get $context $f_4 (local.get $ctx))
        (i32.const 0) (local.get $input) (local.get $input_pos)
        (local.get $input_len))))
)
(func $MD5Final (param $ctx (ref $context)) (result (ref $string))
  ...
  (local.set $in_buf
    (i32.and (i32.wrap_i64 (local.get $len)) (i32.const 0x3f)))
  (local.set $buffer (struct.get $context $f_4 (local.get $ctx)))
  (array.set $string (local.get $buffer) (local.get $in_buf) (i32.const 0x80))
  ...
  (local.set $w (struct.get $context $f (local.get $ctx)))
  (loop $loop
