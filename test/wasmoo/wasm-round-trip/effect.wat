(module
  ...
  (func $apply_continuation
    (param $resolver (ref extern)) (param $v (ref eq))
    (local $t (ref $thunk))
  ...
  (func $raise_unhandled
    ...
    (local.set $effect_unhandled (array.new_fixed $string 0))
    (block $null
  ...
  (func $push_stack
    ...
    (block $done
      (loop $loop
        (global.set $stack
          (struct.new $fiber
            (struct.get $fiber $handlers (local.get $stack_2)) (local.get $k)
            (global.get $stack)))
  ...
  (func $do_perform (param $k0 (ref $cont)) (param $vp (ref eq))
    ...
    (local $handler (ref eq)) (local $k1 (ref $cont)) (local $p (ref $pair))
  ...
  (func $caml_resume_stack (export "caml_resume_stack")
    ...
    (drop
      (block $already_resumed (result (ref eq))
        ...
        (return (local.get $k))))
    (call $caml_raise_constant
      (ref.as_non_null (call $caml_named_value (array.new_fixed $string 0))))
    (ref.i31 (i32.const 0))
  )
  ...
  (func $cps_uncaught_effect_handler
    ...
    (drop
      (call $caml_resume_stack
        (array.get $block (ref.cast (ref $block) (local.get $k))
          (i32.const 1))
        (local.get $ms)))
